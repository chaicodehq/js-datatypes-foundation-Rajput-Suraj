...
export function updatePrices(menu, increase) {
  ...
  for (const [key, value] of Object.entries(menu)) {
    updatedPrices.push([key, value + increase]);
  }
...
export function mergeDailySpecials(regularMenu, specialsMenu) {
  const updatedRegularMenu = typeof regularMenu !== "object" ? {} : regularMenu;
  const updatedSpecialMenu =
    typeof specialsMenu !== "object" ? {} : specialsMenu;

  return { ...updatedRegularMenu, ...updatedSpecialMenu };
}
